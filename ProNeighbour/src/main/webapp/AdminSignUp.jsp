...
<form class="needs-validation" novalidate>
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control form1-control" id="pwd" name="pwd" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
      <label class="form1-label" for="conpwd">Confirm Password :</label>
      <input type="password" class="form-control form1-control" id="conpwd" name="conpwd" required>
      <div class="valid-feedback">Valid.</div>
      <div class="invalid-feedback">Please fill out this field.</div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input list="areaList" class="form-control" id="Area" name="Area" required>
...
%><option value=<%out.print(rs.getString(2));%>>
  ...
  %>			
    ...
    <div class="form-group">
      ...
      <input list="cityList" class="form-control" id="City" name="City" required>
    ...
    <div class="form-group">
      ...
      <input list="stateList" class="form-control" id="State" name="State" required>
    ...
    <input type="submit" value="Sign Up" formmethod="post" formaction="AdminSignUp" class="btn btn-primary">
    </div>
  </form>
  </div>
  </div>
